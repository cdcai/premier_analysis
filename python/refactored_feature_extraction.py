...
prem_dir = os.path.join('/dbfs/home/tnk6/premier/',"")
out_dir = os.path.join('/dbfs/home/tnk6/premier_output/',"")
parq_dir = os.path.join(out_dir, "parquet_fromscript", "")
pkl_dir = os.path.join(out_dir, "pkl_fromscript", "")
samp_dir = os.path.join(out_dir, "samples_fromscript", "")
...
def main():
    ...
    print(prem_dir)
    pq = tp.load_parquets(dir=prem_dir,use_abfss=False)
