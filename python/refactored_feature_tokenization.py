...
data_dir = os.path.join('/dbfs/home/tnk6/premier/',"")
output_dir = os.path.join('/dbfs/home/tnk6/premier_output/',"")

targets_dir = os.path.join(output_dir, "targets_fromscript", "")
pkl_dir = os.path.join(output_dir, "pkl_fromscript", "")

[os.makedirs(path, exist_ok=True) for path in [targets_dir, pkl_dir]]
...
misa_data = pd.read_csv(os.path.join(output_dir, "targets", "") + 'icu_targets.csv')
